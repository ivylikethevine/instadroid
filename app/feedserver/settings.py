...
FEED_TOKEN: str = env_secret("FEED_TOKEN")
MAX_LIMIT: int = 500
...
LOCK_MAX_HOURS: float = control.env_lock_max_hours()
RUN_NOW_MIN_MINUTES: float = control.env_run_now_min_minutes()
