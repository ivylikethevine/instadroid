...
@versioned
def expand_caption(d, p: parsing.Post) -> str:
...
@versioned
def crop_media(d, bounds: str | None, pid: str, clip_top: int = 0, settle: float = 0):
...
@versioned
def capture_carousel(d, p: parsing.Post, pid: str) -> list[str]:
