"""The scripts' command-line entry points: export_openapi, check_new_builds, promote_dump and
...
import check_new_builds
import export_openapi
import new_profile
import promote_dump
import pytest

FEED_445 = Path(__file__).resolve().parents[1] / "igprofiles" / "v424" / "fixtures" / "feed_445.xml"
