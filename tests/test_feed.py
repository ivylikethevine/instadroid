...
def test_caption_mentions_and_hashtags_become_links(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    html = render.caption_html("Dinner with @jane.doe and @bob_99. #foodie #2024 #année\nnext line")
...
def test_caption_links_leave_emails_urls_and_entities_alone(
    ...
    html = render.caption_html("mail me@example.com, see example.com/#top, C# and it's <b>@x</b>")
